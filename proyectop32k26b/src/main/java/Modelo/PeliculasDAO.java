...
public class PeliculasDAO {
    ...
    public int insertarPeliculas(clsPeliculas Peliculas, clsBitacora bitacora) {
        Connection conn = null;
        PreparedStatement stmt = null;
        int rows = 0;
        ...
        try {
            ...
            stmt.setString(2, Peliculas.getNombre());
            stmt.setString(3, Peliculas.getClasificacion());
            stmt.setString(4, Peliculas.getGenero());
            stmt.setString(5, Peliculas.getSubtitulado());
            stmt.setString(6, Peliculas.getIdioma());
            stmt.setDouble(7, Peliculas.getPrecio());
    ...
    public int actualizarPeliculas(clsPeliculas Peliculas, clsBitacora bitacora) {
        Connection conn = null;
        PreparedStatement stmt = null;
        int rows = 0;
        ...
        try {
            ...
            stmt.setDouble(6, Peliculas.getPrecio());
    ...
    public int eliminarPeliculas(clsPeliculas peliculas, clsBitacora bitacora) {
        Connection conn = null;
        PreparedStatement stmt = null;
        int rows = 0;
    ...
    public clsPeliculas obtenerPeliculaPorId(int id, clsBitacora bitacora) {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                peliculas.setGenero(rs.getString("Genero"));
                peliculas.setSubtitulado(rs.getString("Subtitulado"));
                peliculas.setIdioma(rs.getString("Idioma"));
                peliculas.setPrecio(rs.getDouble("Precio"));
            }
